...
define(function(require, exports, module) {
    ...
    var StripView     = require('js/views/pages/StripView');
    ...
    function _createStripViews() {
        ...
        for (var i = 0; i < this.options.stripData.length; i++) {
            var stripView = new StripView({
                ...
                name: this.options.stripData[i].name
            });
            ...
            stripView.on('click', function(evt){
                appState.save('slideshow', this.options.name);
            });
        }
    }
