define(function(require, exports, module) {
    ...
    FlexGrid.DEFAULT_OPTIONS = {
        ...
        gutterRow: undefined,
        itemSize: undefined,
        transition: { curve: Easing.outBack, duration: 1000 }
    };

    function _calcSpacing(width) {
        var itemWidth = this.options.itemSize.get();
    ...
    function _calcPositions(spacing) {
        ...
        for (var i = 0; i < this._items.length; i++) {
            ...
            yPos = this.options.marginTop + row * (this.options.itemSize.get() + this.options.gutterRow);
    ...
    function _animateModifier(index, position, size) {
        ...
        sizeTransitionable.set(size, this.options.transition); window.sizeTransitionable = sizeTransitionable;
    }

    FlexGrid.prototype.getCols = function() {
        return this.currentNumCols;
    }
    ...
    FlexGrid.prototype.commit = function(context) {
        ...
        var specs = [];
            ...
            var size = [this.options.itemSize.get(), this.options.itemSize.get()];
